<?php
session_start();
if(!isset($_SESSION['team_name']) && !isset($_SESSION['team_name']) && !isset($_SESSION['username1']) )
...
<header>
		...
		<a style="font-size: 20px; background:yellow;" href="logout.php">Logout</a>
	</center>
	</nav>
    <br>
    <br>
  ...
  <img class="player_profile" src="<?php echo $row['image'];?>">
	...
	<table>
		...
		<th><input type="number" id="playerid" name="playerid" value="<?php echo $_SESSION['playerid'];?>" style="width:60px"></th>
	  	<th><input type="submit" name="submit" value="view_player" id="view_player"></th></tr></form>
		<tr>
		<th>Role</th>
		<th>Matches</th>
		<th>Country</th>
	...
	<br>
	  ...
	  <table>
		...
		<th>Bid Price</th>
			...
			<?php 
			$sea_bids="SELECT * FROM bids ORDER BY bid_price DESC LIMIT 4";
    ...
    if(isset($_POST["biding"]))
    {
		...
		$ins_bid="INSERT INTO bids (role,player_id,player_name,base_price,points,team_name,bid_price) values ('$Prole',$Pid,'$Pname',$BPrice,$Points,'$Tn',$Bid)";
